	...
	*/
	...
	function getTrending(){
		...
		for($i=0; $i<2; $i++){
			...
			$whatTrend = dbMassData("SELECT * FROM topics WHERE topic = '$tren' ");
			if($whatTrend ==NULL){

				getNews($tren);
				dbQuery("INSERT INTO topics (topic) VALUES ('$tren')");

				file_get_contents('http://www.skimgoat.com/cloud/models/news/twitGet.php');
		...
		return array("status"=>"success", "data"=>$topTrends);
